...
export const FloatingNav = ({
  ...
  return (
    <motion.div
      ...
      className={cn(
        "flex max-w-fit inset-x-0 mx-auto border border-white/[0.2] rounded-full bg-black text-white shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1),0px_1px_0px_0px_rgba(25,28,33,0.02),0px_0px_0px_1px_rgba(25,28,33,0.08)] z-[5000] pr-4 pl-6 py-1.5 items-center justify-center space-x-4",
        className
      )}
    >
