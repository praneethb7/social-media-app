...
function Profile() {
  ...
  {/* Main Content (Profile Card + Posts) */}
  <div className="flex-1 flex flex-col items-center ml-8 mt-8 space-y-8">
    {/* Profile Card */}
    <div className="mt-10 relative z-10 bg-black px-15 py-15 flex flex-row items-start rounded-3xl shadow-md max-w-4xl w-full h-auto">
      {/* Profile Image */}
